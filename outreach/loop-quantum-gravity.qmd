...
```{=html}
<style>
#lqg-app[data-mode="overview"] .lqg-start-equations .lqg-card-id,
#lqg-app[data-mode="overview"] .lqg-start-equations .mjx-label {
  display: none;
}
</style>
...
<header><p class="eyebrow">Quantum geometry · states · amplitudes</p><h1>Loop quantum gravity,<br>unfolded.</h1><p class="lede">The construction is organized around three basic expressions: the Hilbert space, the algebra of observables and the Lorentzian vertex amplitude. The following sections introduce their ingredients and successive expansions.</p></header>
